...
running:
	...
	private static void printUsage() {
		System.out.println("a, add: Add a time entry");
		System.out.println("load: Load the most recent saved state");
		System.out.println("reg, register: Setup a new badge");
		System.out.println("rm, remove: Remove a time entry");
		System.out.println("sign: Sign a completed time entry");
		System.out.println("save: Save the current state");
		System.out.println("s, sum, summary: Get the time entries of a gopher");
		System.out.println("q, quit: Quit Gopher Check");
